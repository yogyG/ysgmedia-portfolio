    ...
    <header class="global-header">
      ...
      <nav class="nav-menu" id="nav-menu">
        ...
        <div class="mobile-actions">
          <a href="contact.html" style="padding: 0.8rem 1.2rem; background: var(--bg-secondary); color: white; font-weight: 600;">Book Free Consultation</a>
...
export function generateFooter(companyData, contactData) {
  return `
    <footer style="background-color: var(--bg-secondary); color: var(--text-light); padding: var(--spacing-lg); margin-top: var(--spacing-xl);">
